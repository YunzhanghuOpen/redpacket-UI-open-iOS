...
- (void)setMessageModel:(RPRedpacketModel *)messageModel {
    ...
    NSString * nikeName = messageModel.sender.userName;
...
- (void)setBoxStatusType:(RedpacketBoxStatusType)boxStatusType {
    ...
    switch (boxStatusType) {
        ...
        default: {
            NSString *greeting = self.messageModel.greeting;
            ...
            if (self.messageModel.redpacketType == RPRedpacketTypeSingle) {
                
                self.describeLable.text = @"给你发了一个红包";
                
            }else if (self.messageModel.redpacketType == RPRedpacketTypeGroupRand ||
                      self.messageModel.redpacketType == RPRedpacketTypeSystem){
            ...
            }else if (self.messageModel.redpacketType == RPRedpacketTypeGroupAvg){
